...
export default function Skills() {
    ...
    const [web2, setweb2] = useState(["cplusplus-plain colored", "javascript-plain colored","dotnetcore-plain colored", "typescript-plain colored", "html5-plain-wordmark colored", "css3-plain-wordmark colored", "bootstrap-plain-wordmark colored", "mysql-original colored", "mongodb-plain colored", "react-original colored", "redux-original colored", "nextjs-plain colored", "nodejs-plain-wordmark colored"])
